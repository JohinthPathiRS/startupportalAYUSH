...
export default function Dashboard() {
  ...
  useEffect(() => {
    axios.get('http://localhost:3000/api/v1/applications', {}, { withCredentials: true })
      .then((response) => {
  ...
  //   axios.post('http://localhost:3000/api/v1/update-application', { id, status }, { withCredentials: true })
  //     .then(() => {
  //       setApplication((prev) =>
  //         prev.map((app) =>
  ...
  //         ...prev,
  //         `Application ${id} has been ${status.toLowerCase()}.`
  //       ]);
  //     })
